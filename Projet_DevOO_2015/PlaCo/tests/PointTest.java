...
public class PointTest {
	...
	public void contenuDansTest1() {
		Point p1 = PointFactory.creePoint(4, 8);
		assert(p1.contenuDans(PointFactory.creePoint(2,1), PointFactory.creePoint(10, 9)));
	}
	
	@Test
	public void contenuDansTest2() {
		Point p1 = PointFactory.creePoint(4, 8);
		assert(p1.contenuDans(PointFactory.creePoint(2,1), PointFactory.creePoint(5, 7)));
	}
