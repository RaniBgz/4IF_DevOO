...
public class RectangleTest {
	...
	public void contenuDansTest1() {
		Rectangle r = new Rectangle(PointFactory.creePoint(3, 3), 2, 4);
		assert(r.contenuDans(PointFactory.creePoint(3, 3), PointFactory.creePoint(5, 7)));
	}
	
	@Test
	public void contenuDansTest2() {
		Rectangle r = new Rectangle(PointFactory.creePoint(3, 3), 2, 4);
		assert(r.contenuDans(PointFactory.creePoint(0, 1), PointFactory.creePoint(16, 18)));
	}
	
	@Test
	public void contenuDansTest3() {
		Rectangle r = new Rectangle(PointFactory.creePoint(3, 3), 2, 4);
		assert(!r.contenuDans(PointFactory.creePoint(2, 1), PointFactory.creePoint(6, 5)));
	}
