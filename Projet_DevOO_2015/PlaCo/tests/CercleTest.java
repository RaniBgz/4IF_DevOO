...
public class CercleTest {
	...
	public void contenuDansTest1() {
		Cercle c = new Cercle(PointFactory.creePoint(3, 3), 2);
		assert(c.contenuDans(PointFactory.creePoint(1, 1), PointFactory.creePoint(5, 5)));
	}
	
	@Test
	public void contenuDansTest2() {
		Cercle c = new Cercle(PointFactory.creePoint(3, 3), 2);
		assert(c.contenuDans(PointFactory.creePoint(0, 1), PointFactory.creePoint(6, 8)));
	}
	
	@Test
	public void contenuDansTest3() {
		Cercle c = new Cercle(PointFactory.creePoint(3, 3), 2);
		assert(!c.contenuDans(PointFactory.creePoint(2, 1), PointFactory.creePoint(6, 8)));
	}
