...
/**
 * Classe contenant l'ensemble des commandes créées pendant l'exécution de
 * l'application
 *
 */
public class ListeDeCdes {
    ...
    /**
     * contient l'ensemble des commandes créées pendant l'exécution de
     * l'application
     */
    private final LinkedList<Commande> liste;
